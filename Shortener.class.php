<?php
/** 
 * Classe per accorciare i link
 * 
 * @author Fabio Compagnoni
 * @copyright Copyright (c) 2020, Fabio Compagnoni
 * @url https://smanettone.eu
 */ 
class Shortener
{
    ...
    {
        if(empty($url))
            throw new Exception("Nessun indirizzo e' stato immesso.");

        if($this->validateUrlFormat($url) == false)
            throw new Exception("L'URL non ha un formato valido.");
